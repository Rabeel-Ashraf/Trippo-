  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text>Status: Preparing Delivery</Text>
        <Text>Estimated Delivery: 30 min</Text>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ActiveGreenBean')}>
          <Text style={{ color: '#fff' }}>View Active GreenBean</Text>
        </TouchableOpacity>
