...
export default function GreenBeanOrderScreen({ navigation }) {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Image style={[StyleSheet.absoluteFill, { width: null, height: null }]} source={{ uri: Background }} />
      <View style={styles.content}>
        <Text style={styles.title}>GreenBean Ordering Process</Text>
        {/* Add form fields for location, address, etc. here */}
